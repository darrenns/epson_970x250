window.onload = function () {
    ...
    function animateAdNew() {
        tlTwo.from(FrameTwoImage,5, {y:-1050}, "-=0") 
        //tlTwo.from(FrameTwoImage,6, {y:-1000, ease: Power4.easeIn}, "-=0")
        //.to(FrameTwoImage,1, {delay: 3, y:1100, ease:Power4.easeout}, "-=1")
        ...
        tlOne.totalDuration(1);
        
        
        //.to(copyFour,1, {delay: 2, opacity:0, ease:Power4.easeout}, "-=0")
    }
